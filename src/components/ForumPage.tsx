...
export function ForumPage({ forumId, user }: ForumPageProps) {
  ...
  const messages: Message[] = [
    {
      ...
      content: 'Welcome to the course! Please introduce yourselves and let me know your programming background. Also, remember that Assignment 1 is due next Friday at midnight.',
      timestamp: '2 hours ago',
      replies: [
        {
          id: '1-1',
          author: { name: 'Alex Chen', role: 'Student' },
          content: 'Hi everyone! I\'m Alex, CS major, and I have experience with Python and Java.',
        ...
        },
        {
          ...
          content: 'Hello! Maria here, Computer Engineering student. Looking forward to this course!',
    ...
    },
    {
      ...
      content: 'Quick question about the binary search tree implementation - should we use recursion or iteration for the insert method?',
      timestamp: '1 hour ago',
      replies: [
        {
          id: '2-1',
          author: { name: 'Dr. Sarah Wilson', role: 'Lecturer' },
          content: 'Great question! Both approaches are valid. Try implementing it recursively first, then as a challenge, implement the iterative version.',
    ...
    },
    {
      ...
      content: 'Has anyone started working on the graph algorithms assignment? I\'m having trouble understanding Dijkstra\'s algorithm.',
      timestamp: '45 minutes ago',
      replies: [],
      likes: 2
    }
  ...
  const getRoleColor = (role: string) => {
    switch (role) {
      ...
      case 'TA': return 'bg-blue-100 text-blue-800';
      ...
      <div className="bg-white dark:bg-gray-900 border-b p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">{forum.course}</p>
          </div>
            ...
            <div className="space-y-4">
              {messages.map((message) => (
                <div key={message.id} className="group">
                  <Card className={`${message.isPinned ? 'border-blue-200 bg-blue-50 dark:bg-blue-950' : ''}`}>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-2 mb-1">
                            ...
                            <Badge variant="secondary" className={`text-xs ${getRoleColor(message.author.role)}`}>
                              {message.author.role}
                            </Badge>
                                  ...
                                  <div className="flex items-start space-x-2">
                                    ...
                                    <div className="flex-1">
                                      <div className="flex items-center space-x-2 mb-1">
                                        ...
                                        <Badge variant="secondary" className={`text-xs ${getRoleColor(reply.author.role)}`}>
                                          {reply.author.role}
                                        </Badge>
          ...
          <div className="p-4">
            ...
            <div className="space-y-2">
              {onlineUsers.map((user) => (
                <div key={user.id} className="flex items-center space-x-2 p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800">
